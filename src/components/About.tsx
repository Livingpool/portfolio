...
export function About() {
  ...
  return (
    <div id="home" className="container mx-auto px-4 mt-40 flex justify-between">
      <div className="head-text">
        <motion.h1 {...fadeInLeft} className='mb-2 font text-yellow-700' style={{ fontSize: '40px' }}>
          About Me
        </motion.h1>
        <motion.p {...fadeInLeft} transition={{ delay: 0.1 }} className='font' style={{ fontSize: '20px' }}>
          Welcome to my site! 
        ...
        <motion.p {...fadeInLeft} transition={{ delay: 0.2 }} className='mt-5 font' style={{ fontSize: '20px' }}>
        ...
        <motion.p {...fadeInLeft} transition={{ delay: 0.3 }} className='mt-5 font text-yellow-900' style={{ fontSize: '20px' }}>
          This is my main skill set:
        </motion.p>

        <motion.div className='flex flex-wrap gap-4'>
          <motion.div {...fadeInUp} transition={{ delay: 0.10 }} className="hard-skills w-10">
            <img src={reactIcon} alt="React" />
          </motion.div>
          <motion.div {...fadeInUp} transition={{ delay: 0.11 }} className="hard-skills w-10">
            <img src={jsIcon} alt="JavaScript" />
          </motion.div>
          <motion.div {...fadeInUp} transition={{ delay: 0.12 }} className="hard-skills w-10">
            <img src={tsIcon} alt="TypeScript" />
          </motion.div>
          <motion.div {...fadeInUp} transition={{ delay: 0.13 }} className="hard-skills w-14">
            <img src={golangIcon} alt="Golang" />
          </motion.div>
          <motion.div {...fadeInUp} transition={{ delay: 0.13 }} className="hard-skills w-9">
            <img src={cIcon} alt="C" />
          </motion.div>
          <motion.div {...fadeInUp} transition={{ delay: 0.13 }} className="hard-skills w-9">
      ...
      <motion.div {...fadeInRight} transition={{ delay: 0.2 }} className='mt-20 ml-40 mr-5'>
